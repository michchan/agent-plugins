...
- Significant acquisitions and their outcomes (deal size, rationale, integration status)
- Notable divestitures or spin-offs
- Key regulatory events (antitrust, fines, settlements)
- Leadership transitions and their context

Organize chronologically. Aim for 1–2 sentences per event.
...
- Date range
- Approximate magnitude (e.g., "−40% over 3 months")

...
Input fields needed to invoke `financial-analysis:dcf`. Historical data and projections come from Step 1 (Financial Model) output; qualitative data and KPIs from Step 2 (Company Research).
...
| Financial model projections | Forward revenue, EBIT, FCF projections | _(from Step 1 output)_ | Current session |

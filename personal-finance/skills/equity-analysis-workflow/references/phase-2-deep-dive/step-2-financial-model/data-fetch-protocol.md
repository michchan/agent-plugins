...
| Income statement (4 years) | Current session (Step 1 output) | — |
| Balance sheet (2 years) | Current session (Step 1 output) | — |
| Cash flow summary (4 years) | Current session (Step 1 output) | — |

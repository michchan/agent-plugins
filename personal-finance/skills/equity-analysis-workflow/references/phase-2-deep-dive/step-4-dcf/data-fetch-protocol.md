# Data Fetch Protocol — Phase 2 / Step 4: DCF Valuation

| Data | Source | Prompt |
|---|---|---|
| Step 3 financial model (forward projections) | Current session; fallback: data file (`*-financial-model.md`) | — |
...
| Historical income statement (4 years) | Current session; fallback: data file (`*-financial-data.md`, Step 1 output) | — |
| Historical cash flow (4 years) | Current session; fallback: data file (`*-financial-data.md`, Step 1 output) | — |
| Balance sheet (debt, cash) | Current session; fallback: data file (`*-financial-data.md`, Step 1 output) | — |
| Key metrics / KPIs | Current session; fallback: data file (`*-financial-data.md`, Step 1 output) | — |
